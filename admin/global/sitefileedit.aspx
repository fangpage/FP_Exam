...
protected override void View()
{
	...
	ViewBuilder.Append("            PageNav(\"系统站点管理," + echo(rawpath) + "sitemanage.aspx|站点文件管理," + echo(rawpath) + "sitefilemanage.aspx?sitepath=" + echo(m_sitepath) + "|站点文件编辑," + echo(rawurl) + "\");\r\n");
	ViewBuilder.Append("            $(\"#btncancle\").click(function () {\r\n");
	ViewBuilder.Append("                PageBack(\"sitefilemanage.aspx?sitepath=" + echo(m_sitepath) + "&path=" + echo(m_path) + "\");\r\n");
	ViewBuilder.Append("            })\r\n");
	ViewBuilder.Append("        });\r\n");
	ViewBuilder.Append("    </");
	ViewBuilder.Append("script>\r\n");
	...
	ViewBuilder.Append("                    <td class=\"newstitle\" bgcolor=\"#ffffff\">编辑站点文件(" + echo(filename) + ")</td>\r\n");
	ViewBuilder.Append("                </tr>\r\n");
	ViewBuilder.Append("            </tbody>\r\n");
