...
protected override void View()
{
	...
	ViewBuilder.Append("            }\r\n");
	ViewBuilder.Append("            $.post(\"desktopajax.aspx\", { type: 'sites', path: '" + echo(siteinfo.sitepath) + "', parentid: parentid }, function (data) {\r\n");
	...
	ViewBuilder.Append("            <a class=\"adminsubmit_long\" style=\"display:block;text-align:center;padding-top:10px;float:left\" href=\"" + echo(siteinfo.indexurl) + "\" target=\"_blank\">浏览站点</a>\r\n");

	if (siteinfo.indexurl!="")
	{
	...
	{
	ViewBuilder.Append("            <a class=\"adminsubmit_long\" style=\"display:block;text-align:center;padding-top:10px;float:left\" href=\"" + echo(siteinfo.adminurl) + "\" target=\"_blank\">打开后台</a>\r\n");
	}//end if
	ViewBuilder.Append("        </td>\r\n");
	ViewBuilder.Append("    </tr>\r\n");
	ViewBuilder.Append("  </table>\r\n");
