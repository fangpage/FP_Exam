...
protected override void View()
{
	...
	ViewBuilder.Append("                return;\r\n");
	ViewBuilder.Append("            }\r\n");
	ViewBuilder.Append("            $.post(\"desktopajax.aspx\", { type: 'app', path: '" + echo(appinfo.installpath) + "', parentid: parentid,name:$(\"#deskname\").val() }, function (data) {\r\n");
	...
	ViewBuilder.Append("            <td><input id=\"name\" name=\"name\" type=\"text\" value=\"" + echo(appinfo.name) + "\" style=\"height:21px;width:400px;\">\r\n");

	if (appinfo.installpath!="")
	{
	...
	ViewBuilder.Append("            <td><input id=\"adminurl\" name=\"adminurl\" type=\"text\" value=\"" + echo(appinfo.adminurl) + "\" style=\"height:21px;width:400px;\"></td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
	...
	ViewBuilder.Append("            <td align=\"left\">\r\n");
	ViewBuilder.Append("              <input id=\"deskname\" name=\"deskname\" type=\"text\" value=\"" + echo(appinfo.name) + "\" style=\"height:21px;width:150px;\">\r\n");
	ViewBuilder.Append("            </td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
