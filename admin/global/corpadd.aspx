<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FangPage.WMS.Admin.corpadd" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("    <title>添加编辑单点服务帐号</title>\r\n");
	...
	ViewBuilder.Append("                window.location.href = \"corpmanage.aspx\";\r\n");
	ViewBuilder.Append("            });\r\n");
	ViewBuilder.Append("            PageNav(\"单点服务帐号管理," + echo(rawpath) + "corpmanage.aspx|添加编辑单点服务帐号," + echo(rawpath) + "" + echo(pagename) + "?id=" + echo(id) + "\");\r\n");
	ViewBuilder.Append("        })\r\n");
	ViewBuilder.Append("    </");
	ViewBuilder.Append("script>\r\n");
	ViewBuilder.Append("</head>\r\n");
	...
	ViewBuilder.Append("          <td class=\"newstitle\" bgcolor=\"#ffffff\">添加编辑单点服务帐号</td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("      </tbody>\r\n");
	...
	ViewBuilder.Append("                        <input name=\"corpid\" type=\"text\" value=\"" + echo(corpinfo.corpid) + "\" id=\"corpid\" style=\"height:21px;width:300px;\">\r\n");
	ViewBuilder.Append("                    </td>\r\n");
	ViewBuilder.Append("                  </tr>\r\n");
	ViewBuilder.Append("                  <tr>\r\n");
	ViewBuilder.Append("                    <td class=\"td_class\"> 单点登录密码： </td>\r\n");
	ViewBuilder.Append("                    <td>\r\n");
	ViewBuilder.Append("                       <input name=\"secret\" type=\"text\" value=\"" + echo(corpinfo.secret) + "\" id=\"secret\" style=\"height:21px;width:300px;\">\r\n");
	ViewBuilder.Append("                    </td>\r\n");
	ViewBuilder.Append("                  </tr>\r\n");
	ViewBuilder.Append("                  <tr>\r\n");
