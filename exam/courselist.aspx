<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_Course.Controller.courselist" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("><a href=\"courselist.aspx?channelid=" + echo(channelid) + "\">全部课程</a></li>\r\n");
	...
	ViewBuilder.Append("><a href=\"courselist.aspx?sortid=" + echo(s_item.id) + "\">" + echo(s_item.name) + "</a></li>\r\n");
	}//end loop
	ViewBuilder.Append("          </ul>\r\n");
	ViewBuilder.Append("        </div>\r\n");
	...
	loop__id=0;
	foreach(CourseInfo item in _courselist)
	{
	loop__id++;
	ViewBuilder.Append("                <div class=\"exercise\">\r\n");
	ViewBuilder.Append("                  <div class=\"pull-right\"></div>\r\n");
	ViewBuilder.Append("                  <div class=\"name\"><a href=\"courseinfo.aspx?id=" + echo(item.id) + "\" target=\"_blank\">" + echo(item.name) + "</a></div>\r\n");
	ViewBuilder.Append("                </div>\r\n");
	}//end loop
	ViewBuilder.Append("              </div>\r\n");
