...
protected override void View()
{
	...
	ViewBuilder.Append("<title>练习结果|" + echo(pagetitle) + "</title>\r\n");
	...
	ViewBuilder.Append("      <span class=\"tab3 tab3a\">练习结果</span>\r\n");
	...
	ViewBuilder.Append("                <p class=\"count1\">练习得分</p>\r\n");
	...
	ViewBuilder.Append("                  <td>练习总题数</td>\r\n");
	ViewBuilder.Append("                  <td>答对题数</td>\r\n");
	ViewBuilder.Append("                  <td>练习总分</td>\r\n");
	...
	loop__id++;
	ViewBuilder.Append("                  <tr>\r\n");
	ViewBuilder.Append("                    <td>" + echo(examtopic.questions) + "</td>\r\n");
	ViewBuilder.Append("                    <td>" + echo((examtopic.questions-examtopic.wrongs)) + "</td>\r\n");
	ViewBuilder.Append("                    <td>100</td>\r\n");
	...
	ViewBuilder.Append("                      练习时间：" + echo(examresult.endtime,"yyyy-MM-dd HH:mm:ss") + "\r\n");
