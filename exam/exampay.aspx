<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_Exam.Controller.exampay" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("<title>考试支付-[" + echo(exampayinfo.title) + "]|" + echo(pagetitle) + "</title>\r\n");
	...
	ViewBuilder.Append("           window.location.href = \"examview.aspx?examid=" + echo(exampayinfo.examid) + "\";\r\n");
	ViewBuilder.Append("        });\r\n");
	...
	ViewBuilder.Append("          url: 'exampay_status.aspx?id=" + echo(exampayinfo.id) + "',\r\n");
	ViewBuilder.Append("          dataType: \"json\",\r\n");
	ViewBuilder.Append("          success: function (result) {\r\n");
	ViewBuilder.Append("            if(result.code==1)\r\n");
	ViewBuilder.Append("            {\r\n");
	ViewBuilder.Append("              window.clearInterval(testCountdown);\r\n");
	ViewBuilder.Append("              alert(\"支付成功\");\r\n");
	ViewBuilder.Append("              window.location.href = \"examview.aspx?examid=" + echo(exampayinfo.examid) + "\";\r\n");
	ViewBuilder.Append("            }\r\n");
	ViewBuilder.Append("            else\r\n");
	ViewBuilder.Append("            {\r\n");
	ViewBuilder.Append("              console.log(result.msg);\r\n");
	ViewBuilder.Append("            }\r\n");
	ViewBuilder.Append("          }\r\n");
	ViewBuilder.Append("        });\r\n");
	...
	ViewBuilder.Append("              <td height=\"50\" align=\"center\" style=\"background:#fffbe1\"><span style=\"font-size:17px;text-align: center;color:#444;font-weight:bold; font-family:'微软雅黑'\">" + echo(exampayinfo.title) + "</span></td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
	ViewBuilder.Append("              <td align=\"center\" style=\"background:#fff url(" + echo(webpath) + "" + echo(sitepath) + "/statics/images/trbg.png) no-repeat 0 100%;\">\r\n");
	ViewBuilder.Append("                &nbsp;&nbsp; &nbsp;&nbsp;微信扫描支付<br>\r\n");
	ViewBuilder.Append("                      <img style=\"margin-left:30px;\" src=\"" + echo(webpath) + "plugins/code/qrcode.aspx?content=" + echo(exampayinfo.codeurl) + "&logo=" + echo(webpath) + "exam/logo/logo_top.png\">\r\n");
	...
	ViewBuilder.Append("    <img id=\"startexam\" src=\"" + echo(webpath) + "" + echo(sitepath) + "/statics/images/btn_back.png\" style=\"cursor:pointer;\" border=\"0\">\r\n");
	ViewBuilder.Append("  </div>\r\n");
