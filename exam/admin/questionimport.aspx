...
protected override void View()
{
	...
	ViewBuilder.Append("        PageNav(\"考试题库管理," + echo(rawpath) + "questionmanage.aspx?sortid=" + echo(sortid) + "|" + echo(sortinfo.name) + "," + echo(rawpath) + "questionmanage.aspx?sortid=" + echo(sortid) + "|Excel导入题目," + echo(rawurl) + "\");\r\n");
	...
	ViewBuilder.Append("          <td class=\"newstitle\" bgcolor=\"#ffffff\">Excel导入题目，所在题库：" + echo(sortinfo.name) + "</td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("      </tbody>\r\n");
	...
	ViewBuilder.Append("                       <a href=\"template/import.xls\">下载题目录入格式表</a>\r\n");
	ViewBuilder.Append("                    </td>\r\n");
	ViewBuilder.Append("                  </tr>\r\n");
	ViewBuilder.Append("                  <tr>\r\n");
