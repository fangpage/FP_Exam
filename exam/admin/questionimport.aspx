...
protected override void View()
{
	...
	ViewBuilder.Append("<title>导入题目</title>\r\n");
	...
	ViewBuilder.Append("        PageNav(\"考试题库管理," + echo(rawpath) + "questionmanage.aspx?sortid=" + echo(sortid) + "|" + echo(sortinfo.name) + "," + echo(rawpath) + "questionmanage.aspx?sortid=" + echo(sortid) + "|导入题目," + echo(rawurl) + "\");\r\n");
	ViewBuilder.Append("        $(\"#btncancle\").click(function () {\r\n");
	ViewBuilder.Append("            window.location.href = \"questionmanage.aspx?sortid=" + echo(sortid) + "\";\r\n");
	ViewBuilder.Append("        })\r\n");
	ViewBuilder.Append("    });\r\n");
	ViewBuilder.Append("</");
	ViewBuilder.Append("script>\r\n");
	...
	ViewBuilder.Append("          <td class=\"newstitle\" bgcolor=\"#ffffff\">导入题目，所在题库：" + echo(sortinfo.name) + "</td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("      </tbody>\r\n");
	...
	ViewBuilder.Append("                <tbody>\r\n");
	ViewBuilder.Append("                  <tr>\r\n");
	ViewBuilder.Append("                    <td class=\"td_class\">题库文件： </td>\r\n");
	...
	ViewBuilder.Append("                    <td class=\"td_class\"></td>\r\n");
	ViewBuilder.Append("                    <td height=\"25\">\r\n");
	ViewBuilder.Append("                    <span style=\"font-weight:bold;color:#ff0000\">支持Word和Excel导入题目，请先下载录入模板：</span> <br>\r\n");
	ViewBuilder.Append("                      <a href=\"template/Word录入模板.docx\">1.下载Word录入模板</a><br>\r\n");
	ViewBuilder.Append("                      <a href=\"template/Excel录入模板.xls\">2.下载Excel录入模板</a>\r\n");
	ViewBuilder.Append("                    </td>\r\n");
	ViewBuilder.Append("                  </tr>\r\n");
	ViewBuilder.Append("                </tbody>\r\n");
	ViewBuilder.Append("              </table>\r\n");
