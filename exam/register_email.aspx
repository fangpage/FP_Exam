...
protected override void View()
{
	...
	ViewBuilder.Append("script>\r\n");
	ViewBuilder.Append("<script type=\"text/javascript\" src=\"" + echo(webpath) + "" + echo(sitepath) + "/statics/js/register.js\"></");
	ViewBuilder.Append("script>\r\n");
	ViewBuilder.Append("</head>\r\n");
	...
	ViewBuilder.Append("                                    <input id=\"email\" name=\"email\" type=\"text\" placeholder=\"请输入您的邮箱地址\">\r\n");
	...
	ViewBuilder.Append("                            <div class=\"item-wrap text-item-wrap\">\r\n");
	ViewBuilder.Append("                                <label for=\"realname\">短信验证码：</label>\r\n");
	ViewBuilder.Append("                                <span class=\"text-wrap\">\r\n");
