<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_Exam.Controller.testhistory" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("<title>我的练习|" + echo(pagetitle) + "</title>\r\n");
	...
	ViewBuilder.Append("            <li class=\"active\"><a href=\"testhistory.aspx\">我的练习</a></li>\r\n");
	...
	{
	ViewBuilder.Append("                  <div class=\"pull-right\">\r\n");
	ViewBuilder.Append("                    <a href=\"testanswer.aspx?resultid=" + echo(item.id) + "\" target=\"_blank\" class=\"btn btn-link link-button\"><span class=\"btn-inner\">查看结果</span></a>\r\n");
	ViewBuilder.Append("                  </div>\r\n");
	ViewBuilder.Append("                  <div class=\"name\"><a href=\"testanswer.aspx?resultid=" + echo(item.id) + "\" target=\"_blank\">" + echo(item.examname) + "(得分：" + echo(item.score) + "分)</a></div>\r\n");
	}//end if
	ViewBuilder.Append("                  <div class=\"meta\"> <span class=\"muted\">练习时间: " + echo(item.starttime,"yyyy年MM月dd日 HH:mm") + "</span> <span class=\"muted\"> </span> </div>\r\n");
	ViewBuilder.Append("                </div>\r\n");
	}//end loop
	ViewBuilder.Append("              </div>\r\n");
