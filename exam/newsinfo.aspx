...
protected override void View()
{
	...
	ViewBuilder.Append("<title>" + echo(_newsinfo.title) + "|" + echo(pagetitle) + "</title>\r\n");
	...
	ViewBuilder.Append("            <li style=\"text-align:center; width:100%\"><strong>" + echo(_newsinfo.title) + "</strong>\r\n");
	ViewBuilder.Append("            </li>\r\n");
	ViewBuilder.Append("          </ul>\r\n");
	ViewBuilder.Append("        </div>\r\n");
