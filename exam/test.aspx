...
protected override void View()
{
	...
	ViewBuilder.Append("script>\r\n");
	ViewBuilder.Append("<script src=\"" + echo(webpath) + "" + echo(sitepath) + "/statics/js/test.js?v=" + echo(version) + "\" type=\"text/javascript\"></");
	ViewBuilder.Append("script>\r\n");
	...
	ViewBuilder.Append("      <span class=\"write\">自由练习<span class=\"ft3\">(共" + echo(limit) + "题)</span></span></div>\r\n");
