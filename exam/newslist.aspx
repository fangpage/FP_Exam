...
protected override void View()
{
	...
	ViewBuilder.Append("><a href=\"newslist.aspx?channelid=" + echo(channelid) + "\">全部课程</a></li>\r\n");
	...
	ViewBuilder.Append("><a href=\"newslist.aspx?sortid=" + echo(s_item.id) + "\">" + echo(s_item.name) + "</a></li>\r\n");
	}//end loop
	ViewBuilder.Append("          </ul>\r\n");
	ViewBuilder.Append("        </div>\r\n");
	...
	ViewBuilder.Append("                  <div class=\"name\"><a href=\"newsinfo.aspx?id=" + echo(item.id) + "\" target=\"_blank\">" + echo(item.title) + "</a></div>\r\n");
	ViewBuilder.Append("                  <div class=\"meta\"> <span class=\"muted\">发布时间: " + echo(item.postdatetime,"yyyy年MM月dd日 HH:mm") + "</span> <span class=\"muted\"> </span> </div>\r\n");
	ViewBuilder.Append("                </div>\r\n");
	}//end loop
	ViewBuilder.Append("              </div>\r\n");
