<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FangPage.WMS.Web.Controller.forget" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("<title>忘记密码|" + echo(pagetitle) + "</title>\r\n");
	...
	ViewBuilder.Append("            <h1 class=\"page-header first\"><span class=\"text\"><span class=\"sprite sprite-notepad\"></span>忘记密码</span>\r\n");
	...
	if (ispost)
	{
	ViewBuilder.Append("                      <div class=\"main952_box martop20\" style=\"font-size:20px;text-align:center\">\r\n");
	ViewBuilder.Append("                        " + echo(msg) + "<br>\r\n");
	ViewBuilder.Append("                        请登录您的注删邮箱进行查收。\r\n");
	ViewBuilder.Append("                      </div>\r\n");
	}
	else
	{
	...
	ViewBuilder.Append("                                <label for=\"realname\">输入注册邮箱：</label>\r\n");
	ViewBuilder.Append("                                <span class=\"text-wrap\">\r\n");
	ViewBuilder.Append("                                    <input id=\"email\" name=\"email\" type=\"text\" placeholder=\"请输入注册电子邮箱地址\">\r\n");
