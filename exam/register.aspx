...
protected override void View()
{
	...
	ViewBuilder.Append("<title>帐户注册|" + echo(pagetitle) + "</title>\r\n");
	...
	ViewBuilder.Append("script>\r\n");
	ViewBuilder.Append("<script type=\"text/javascript\" src=\"" + echo(webpath) + "" + echo(sitepath) + "/statics/js/register_acount.js\"></");
	ViewBuilder.Append("script>\r\n");
	ViewBuilder.Append("</head>\r\n");
	...
	ViewBuilder.Append("            <h1 class=\"page-header first\"><span class=\"text\"><span class=\"sprite sprite-notepad\"></span>帐户注册</span>\r\n");
	...
	ViewBuilder.Append("                                <label for=\"signupFormEmailInput\">姓名：</label>\r\n");
	ViewBuilder.Append("                                <span class=\"text-wrap\">\r\n");
	ViewBuilder.Append("                                    <input id=\"username\" name=\"username\" type=\"text\" placeholder=\"请输入用户名\">\r\n");
	ViewBuilder.Append("                                </span><span id=\"username_msg\" class=\"item-message help-inline\"></span>\r\n");
	ViewBuilder.Append("                            </div>\r\n");
	ViewBuilder.Append("                            <div class=\"item-wrap text-item-wrap\">\r\n");
	...
	ViewBuilder.Append("                            </div>\r\n");
	ViewBuilder.Append("                            <div class=\"item-wrap text-item-wrap\">\r\n");
	ViewBuilder.Append("                                <label for=\"email\">手机号码：</label>\r\n");
	ViewBuilder.Append("                                <span class=\"text-wrap\">\r\n");
	ViewBuilder.Append("                                    <input id=\"mobile\" name=\"mobile\" type=\"text\" placeholder=\"请输入手机号码\">\r\n");
	ViewBuilder.Append("                                </span><span id=\"mobile_msg\" class=\"item-message help-inline\"></span>\r\n");
	ViewBuilder.Append("                            </div>\r\n");
	ViewBuilder.Append("                            <div class=\"item-wrap text-item-wrap\">\r\n");
	ViewBuilder.Append("                                <label for=\"email\">电子邮箱：</label>\r\n");
	ViewBuilder.Append("                                <span class=\"text-wrap\">\r\n");
	ViewBuilder.Append("                                    <input id=\"email\" name=\"email\" type=\"text\" placeholder=\"请输入电子邮箱\">\r\n");
	ViewBuilder.Append("                                </span><span id=\"email_msg\" class=\"item-message help-inline\"></span>\r\n");
	ViewBuilder.Append("                            </div>\r\n");
