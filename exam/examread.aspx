...
protected override void View()
{
	...
	ViewBuilder.Append("      <span class=\"line1\"></span><span class=\"write\">姓名：<span title=\"" + echo(examresult.realname) + "(" + echo(examresult.username) + ")\">" + echo(examresult.realname) + "(" + echo(examresult.username,8)+ ")</span></span>\r\n");
	ViewBuilder.Append("    </div>\r\n");
	ViewBuilder.Append("  </div>\r\n");
	ViewBuilder.Append("</div>\r\n");
	ViewBuilder.Append("<div class=\"hbx2\">\r\n");
	...
	ViewBuilder.Append("                      考试时间：" + echo(examresult.starttime,"yyyy-MM-dd HH:mm:ss") + "\r\n");
	...
	{
	ViewBuilder.Append("                      ~" + echo(examresult.endtime,"yyyy-MM-dd HH:mm:ss") + "，尚未阅卷。\r\n");
	}
	else if (examresult.status==2)
	{
	ViewBuilder.Append("                      ~" + echo(examresult.endtime,"yyyy-MM-dd HH:mm:ss") + "，已阅卷。\r\n");
	}//end if
