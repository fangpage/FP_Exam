...
protected override void View()
{
	...
	ViewBuilder.Append("	</div>\r\n");
	ViewBuilder.Append("</div>\r\n");
	ViewBuilder.Append("<div class=\"content-wrap answer wrapper\" style=\"word-wrap: break-word;\">\r\n");
	...
	if (questioninfo.userscore>0)
	{
	ViewBuilder.Append("<div class=\"icon right\"></div>\r\n");
	}//end if
	else if (questioninfo.userscore==0)
	{
	ViewBuilder.Append("<div class=\"icon wrong\"></div>\r\n");
	}//end if
	ViewBuilder.Append("    </div>\r\n");
	...
	ViewBuilder.Append("    </div>\r\n");
	ViewBuilder.Append("    </div>\r\n");
	ViewBuilder.Append("    <div class=\"result-wrap\">\r\n");
	...
	{
	ViewBuilder.Append("<span>" + echo(questioninfo.answer) + "</span>\r\n");
	}//end if
	ViewBuilder.Append("        </div>\r\n");
	ViewBuilder.Append("        </div>\r\n");
